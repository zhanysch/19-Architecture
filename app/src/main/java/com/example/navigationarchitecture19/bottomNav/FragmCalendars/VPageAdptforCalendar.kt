package com.example.navigationarchitecture19.bottomNav.FragmCalendars
...
class VPageAdptforCalendar (fragment : FragmentManager):FragmentStatePagerAdapter(fragment) {
